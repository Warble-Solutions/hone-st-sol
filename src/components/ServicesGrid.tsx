...
const verticals = [
  ...
  },
  {
    ...
    description: 'Boardroom-level strategy, organisational restructuring and systems standardisation. We work side-by-side with leadership to implement operational clarity and unlock sustainable growth',
  ...
  },
  {
    ...
    description: 'Digital solutions are the components of marketing that utilise internet and online-based digital technologies to promote products and services',
  ...
  },
  {
    ...
    highlights: ['The Corporate Bhagavad Gita', 'Illustrated Children\'s Storybooks', '50% Royalties to Girls\' Education'],
  },
];
