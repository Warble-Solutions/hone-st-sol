...
export default function HomePage() {
  const homeFaqs = [
    {
      q: "What makes Hone ST Solutions unique compared to typical consulting agencies?",
      a: "Germination of an idea in the year 2018 has resulted in adding value to 75+ organizations and 25,000+ individuals. This has been made possible by countless boardroom strategies executed on the ground, training and mentoring of the workforce spanning over 100 years resulting in experience, expertise, empathy and exuberance. Guided by our belief that 'Together We Can Make a Difference', we work side-by-side with leadership in Ahmedabad and across India to implement systems, train teams experiential-first, and deploy automated tech."
    },
    {
    ...
    {
      q: "Can we engage Hone ST Solutions strictly for Digital Engineering and AI Agents?",
